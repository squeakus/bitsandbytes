...
% do the actual learning and also testing. Required: a previous call to
...
plotRunlength = 100;
sparsePlotting = 0; %1= true, 0=false. If true, fewer graphics are produced
...
if length(plotStates) > 0 & ~sparsePlotting
    figure(3);
    subplot(2,2,1);
    plot(statePL(1,:));
