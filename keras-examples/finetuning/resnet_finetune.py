...
# what is dropout
# D = width??
# pooling and classes in constructor
...
def main():
    ...
    model = add_new_fc_layer(baseModel, len(classNames))
    ...
    plot(history_tl, TL_EPOCHS, "resnet_tl_plot.png")
    # now that the head FC layers have been trained/initialized, lets
    # unfreeze the final set of CONV layers and make them trainable
    for layer in baseModel.layers[:FROZEN_LAYERS]:
    ...
    print(classification_report(testY.argmax(axis=1),
        predictions.argmax(axis=1), target_names=classNames))
    plot(history_ft, FT_EPOCHS, "resnet_ft_plot.png")
...
def add_new_fc_layer(baseModel, classes):
