            ...
            if packet.stream_name == 'left' or packet.stream_name == 'right':
                ...
                if complete == False:                    
                    if framecnt % 60 is 0:
                        ...
                        board_detected, corners = cv2.findChessboardCorners(small, (9,6),chessboard_flags)
                        if board_detected:
                            rightcolor = (0, 255, 0)
                        else:
                            rightcolor = (0, 0, 255)
                    ...
                    cv2.putText(frame, "Align cameras with callibration board and press spacebar to capture the image:", (0, 25), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0))
